...
<body class="bg-success p-2 text-white bg-opacity-75">
    ...
    <br>
    <br>
    <a href="inputBarang.php" class="text-decoration-none bg-info text-white p-2">Tambah Barang</a>
    <br><br>
    <a href="transaksi.php" class="text-decoration-none bg-info text-white p-2">Daftar Teransaksi</a>
    <br>
    <br>
